#
#  Be sure to run `pod spec lint CJCycleScrollView.podspec' to ensure this is a
...
"CJCycleScrollView是一个可以自定义内容且不复用的轮播图"
  ...
  # Or just: s.author    = "CJProgrammer"
  # s.authors            = { "CJProgrammer" => "727459774@qq.com" }
  # s.social_media_url   = "http://twitter.com/CJProgrammer"
